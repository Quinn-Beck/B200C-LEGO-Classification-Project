...
def data_generator(train_t, eval_t, num_classes = 10):
    ...
    train_data = Subset(full_train_data, range(3200*num_classes))
    val_data = Subset(full_val_data, range(400*num_classes))
    test_data = Subset(full_test_data, range(400*num_classes))
